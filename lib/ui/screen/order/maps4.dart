...
class SearchLokasiKolam extends StatefulWidget {
  @override
  State<SearchLokasiKolam> createState() => _MyAppState();
}

class _MyAppState extends State<SearchLokasiKolam> {
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            var jarak =
                                calculateDistance(tikom_adijasa, current);
                            if (jarak > 25) {
